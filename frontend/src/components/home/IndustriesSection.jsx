...
const IndustriesSection = () => {
  ...
  const filteredIndustries = industries.filter((industry) => {
    ...
    if (activeFilter === 'regulated')
      return ['government', 'pharmaceutical', 'life-sciences', 'legal', 'immigration-law', 'financial-services'].includes(industry.id);
    if (activeFilter === 'agencies')
      return ['marketing', 'sales'].includes(industry.id);
    return !['marketing', 'sales', 'government', 'pharmaceutical', 'life-sciences', 'legal', 'immigration-law', 'financial-services'].includes(industry.id);
  });
